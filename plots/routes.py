...
# ---------------------------------------------------------------------------
ROUTE_ANALYSIS_DESCRIPTION = """Structural analysis of transit route designs.
...
Usage:
    python plots/main.py analyze-routes
    python plots/main.py analyze-routes --alpha 1_0
    python plots/main.py analyze-routes --csv /tmp/routes.csv
"""

TRANSIT_CENTER = TRANSIT_CENTER_NODE
...
# Main
# ---------------------------------------------------------------------------
def analyze_routes_main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        description="Structural route analysis",
        epilog=ROUTE_ANALYSIS_DESCRIPTION,
